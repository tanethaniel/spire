...
function App() {
  ...
  const { patterns, savedCount, loading: patternsLoading, reset: resetPatterns, update: updatePatterns, submitFeedback, toggleSave, dismiss, triggerTrickle } = usePatternNotes(authed, interpretationEnabled);
